...
For the inlet boundary condition, a total tmeperature and total pressure was choosening, inline with Nasa case where the inlet velocity will be allowed to float...

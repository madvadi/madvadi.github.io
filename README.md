...
With the initial field for pressure being set to a uniform 0, for velocity, a uniform 0 m/s in all direction.

The results compared with the vadlidation data in Ghia et al,1982 are presented in Figure 1:
